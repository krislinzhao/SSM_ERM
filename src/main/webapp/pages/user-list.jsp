            ...
            <div class="box box-primary">
                            ...
                            <c:forEach items="${pageInfo.list}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/user/findById.do?userId=${user.id}"
                                           class="btn bg-olive btn-xs">详情</a>
                                        <a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?userId=${user.id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=1&pageSize=${pageInfo.pageSize}"
